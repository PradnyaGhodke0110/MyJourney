...
MarvellousLogin()
{
    ...
    TopLabel.setText("Pradnyas Packer Unpacker:Login");
    TopLabel.setForeground(Color.BLUE);

    Dimension topsize=TopLabel.getPreferredSize();
    TopLabel.setBounds(505,40,topsize.width,topsize.height);
...
public void actionPerformed(ActionEvent ae)
{
   ...
   if(ae.getSource()==SUBMIT)
   {
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(this,"Incorrect login or password","Error",JOptionPane.ERROR.ERROR_MESSAGE);
        }
   }
